...
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33  IOB TRUE } [get_ports { spi_flash_sclk }]; // use STARTUPE2 instead

set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33  IOB TRUE } [get_ports { spi_flash_scs }]; #IO_L6P_T0_FCS_B_14 Sch=flash_qspi_cs
