...
#Pmod Header JD
set_property -dict { PACKAGE_PIN V15    IOSTANDARD LVCMOS33 } [get_ports { pjtag_rtdo }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN U12    IOSTANDARD LVCMOS33 } [get_ports { pjtag_rtrstnn }]; #IO_L11N_T1_SRCC_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN V13    IOSTANDARD LVCMOS33 } [get_ports { pjtag_rtck }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN T13    IOSTANDARD LVCMOS33 } [get_ports { pjtag_rtdi }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
set_property -dict { PACKAGE_PIN R11    IOSTANDARD LVCMOS33 } [get_ports { pjtag_rtms }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
